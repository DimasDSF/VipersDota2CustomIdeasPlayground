...
test('math.mapl calc test', function(a)
	a.equal(math.mapl(7,0,10,0,1000), 700.0)
	a.equal(math.mapl(4.5,0,10,0,1000), 450.0)
	a.equal(math.mapl(-2,0,10,0,1000), 0.0)
	a.equal(math.mapl(11,0,10,0,1000), 1000.0)
end)

test('math.mapl should return nil if values are nil or not numbers', function(a)
	a.equal(math.mapl(nil,0,10,0,1000), nil)
	a.equal(math.mapl(7,nil,10,0,1000), nil)
	a.equal(math.mapl(7,0,nil,0,1000), nil)
	a.equal(math.mapl(7,0,10,nil,1000), nil)
	a.equal(math.mapl(7,0,10,0,nil), nil)
	a.equal(math.mapl(7,0,10,0), nil)
	a.equal(math.mapl("test",0,10,0,1000), nil)
end)
